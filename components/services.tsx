...
export default function Services() {
  ...
  return (
    <section id="services" className="py-12 sm:py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        {/* Mobile Carousel */}
        <div className="block sm:hidden overflow-hidden" ref={emblaRef}>
          <div className="flex touch-pan-y">
            {services.map((service, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.4, delay: isClient ? index * 0.1 : 0 }}
              ...
              >
                ...
                >
                  <div className="bg-black/60 rounded-lg p-4 h-full flex flex-col">
                    <div className={`bg-gradient-to-r ${service.color} p-2 rounded-lg w-fit mb-3`}>{service.icon}</div>
                    <h3 className="text-lg font-bold mb-2">{service.title}</h3>
                    <p className="text-white/70 mb-3 flex-grow text-sm">{service.description}</p>
